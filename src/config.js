export default (env) => {
  return {
    production: {
      ...
      aiPrompt:
        "Составь краткое резюме статьи в виде ровно 7 пунктов. " +
        "Соблюдай сквозную нарративную линию: от постановки проблемы — через ключевые подходы и решения — к результатам и выводам. " +
        "Каждый пункт — суть изменений, инноваций или ключевых фактов. " +
        "Стиль: ёмко, сухо, объективно, без преувеличений и оценочных суждений. " +
        'Формат: только пункты, каждый с новой строки, начиная с "- ". ' +
        "Никакого вступления и заключения. Только на русском языке.",
      bodyLimit: 2000,
      postsPerMessage: 5,
      feeds: {
